...
public partial class Form1 : Form
{
    ...
    private async void AuthorsReader(ComboBox cbox)
    {
        ...
        try
        {
            ...
            using (reader = await cmdAuthors.ExecuteReaderAsync())
            {
                bool flag = false;
                while (reader.Read())
                {
    ...
    public async void CategoriesReader(ComboBox cbox)
    {
...
WaitFor Delay '00:00:03'";
        ...
        try
        {
            using (reader = await cmdCategories.ExecuteReaderAsync())
            {
                while (reader.Read())
                    for (int i = 0; i < reader.FieldCount; i++)
    ...
    private async void BooksReader(ListView lView)
    {
        SqlDataReader? reader = null;
